...
const int PhotopeakLineDisplay::sm_xmlSerializationVersion = 0;
  ...
  switch( column )
  {
...
#else
        case SandiaDecay::kAlpha:                   return WString( "&alpha;" );
        case SandiaDecay::kBeta:                    return WString( "&beta;<sup>-</sup>" );
        case SandiaDecay::kBetaPlus:                return WString( "&beta;<sup>+</sup>" );
    ...
    case kParticleType:
    {
      switch( dataRow.particle )
      {
        ...
        case alpha:          return WString( "&alpha;" );
#endif
...
PhotopeakLineDisplay::PhotopeakLineDisplay(
    ...
    m_currentlyShowingNuclide()
{
  ...
  if( !chart )
    throw runtime_error( "PhotopeakLineDisplay: a valid chart"
                         " must be passed in" );
  ...
  WTabWidget *tabWidget = (WTabWidget *)0;
  if( specViewer->isPhone() )
  {
    addStyleClass( "PhotopeakLineDisplayMobile" );
  ...
  {
    addStyleClass( "PhotopeakLineDisplay" );
    setLayout( m_layout );
  ...
  m_layout->setContentsMargins( 1, 2, 3, 1 );
...
//  m_nuclideEdit->changed().connect( boost::bind( &PhotopeakLineDisplay::handleIsotopeChange, this, false ) );
//  m_nuclideEdit->blurred().connect( boost::bind( &PhotopeakLineDisplay::handleIsotopeChange, this, false ) );
//  m_nuclideEdit->enterPressed().connect( boost::bind( &PhotopeakLineDisplay::handleIsotopeChange, this, false ) );
  m_nuclideEdit->changed().connect( boost::bind( &PhotopeakLineDisplay::handleIsotopeChange, this, false ) );
  
//  m_nuclideEdit->selected().connect( boost::bind( &PhotopeakLineDisplay::handleIsotopeChange, this, false ) );
  ...
  m_showLines = new WCheckBox( "Show Lines" );
  m_showLines->setMinimumSize( optionWidth, WLength::Auto );
  m_showLines->setAttributeValue( "style", m_showLines->attributeValue("style")
                                           + "white-space:nowrap;" );
  m_showLines->setChecked( true );
  m_layout->addWidget( m_showLines, 0, 2,  1, 1, AlignLeft | AlignMiddle );
  m_showLines->checked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_showLines->unChecked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  ...
  m_ageEdit->changed().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_ageEdit->blurred().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_ageEdit->enterPressed().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  ...
  m_layout->addWidget( m_halflife, 1, 2, 1, 1, AlignLeft | AlignMiddle );
...
//  m_promptLinesOnly->setHiddenKeepsGeometry( true );  //XXX - causes display to function badly; why?
  m_promptLinesOnly->checked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_promptLinesOnly->unChecked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_promptLinesOnly->hide();
  m_layout->addWidget( m_promptLinesOnly, 2, 2, 1, 1, AlignLeft | AlignMiddle );
...
//  m_lowerBrCuttoff->setMinimumSize( fieldWidth, WLength::Auto );
  ...
  m_lowerBrCuttoff->valueChanged().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  ...
  specViewer->detectorChanged().connect( boost::bind( &PhotopeakLineDisplay::handleIsotopeChange, this, true ) );
  specViewer->detectorModified().connect( boost::bind( &PhotopeakLineDisplay::handleIsotopeChange, this, true ) );
  
  m_layout->addWidget( m_detectorDisplay, 3, 0,  1, 3 );
  ...
  m_shieldingSelect->materialChanged().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_shieldingSelect->materialModified().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_layout->addWidget( m_shieldingSelect, 4, 0, 1, 3 );
  ...
  m_persistLines->clicked().connect( this, &PhotopeakLineDisplay::persistCurentLines );
  m_layout->addWidget( m_persistLines, 0, 3 );
  ...
  m_clearLines->clicked().connect( this, &PhotopeakLineDisplay::clearAllLines );
  m_layout->addWidget( m_clearLines, 1, 3 );
  ...
  //m_fitPeaks->clicked().connect( this, &PhotopeakLineDisplay::fitPeaks );
  //m_layout->addWidget( m_fitPeaks, 2, 3 );
  //m_fitPeaks->disable();
  ...
  m_showGammas->checked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_showGammas->unChecked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_showXrays->checked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_showXrays->unChecked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_showAlphas->checked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_showAlphas->unChecked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_showBetas->checked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  m_showBetas->unChecked().connect( this, &PhotopeakLineDisplay::updateDisplayChange );
  
  m_layout->addWidget( whatToShow, 3, 3, 2, 1 );
  ...
  if( tabWidget )
  {
    tabWidget->addTab( m_particleView, "Energies", WTabWidget::PreLoading );
  }else
  {
    m_layout->addWidget( m_particleView, 0, 4, 5, 1 );
  ...
  //WTableView seems to only render ~6 rows, untill you scroll the WTableView;
  //  I assume this is probably a bug in WTableView::computeRenderedArea(),
  //  but I havent yet bothered to figure this out well
...
//  m_nuclideEdit->setTabIndex( 0 );
//  m_ageEdit->setTabIndex( 1 );
//  m_lowerBrCuttoff->setTabIndex( 2 );
//  m_showLines->setTabIndex( 3 );
//  m_promptLinesOnly->setTabIndex( 4 );
//  m_persistLines->setTabIndex( 5 );
//  m_clearLines->setTabIndex( 6 );
//  m_shieldingSelect;

//  WWidget::setTabOrder( m_nuclideEdit, m_ageEdit );
}//PhotopeakLineDisplay constructor
...
const ReferenceLineInfo &PhotopeakLineDisplay::currentlyShowingNuclide() const
{
...
const std::vector<ReferenceLineInfo> &
                                 PhotopeakLineDisplay::persistedNuclides() const
{
  return m_persisted;
}


void PhotopeakLineDisplay::setFocusToIsotopeEdit()
{
...
void PhotopeakLineDisplay::handleIsotopeChange( const bool useCurrentAge )
{
...
void PhotopeakLineDisplay::updateDisplayChange()
{
  bool show = true;
  show = (show && m_showLines->isChecked());
...
//        UtilityFunctions::replace_all( reactions, "'", "\'" );
    ...
    {
      cerr << "PhotopeakLineDisplay::updateDisplayChange(): " <<e.what()<< endl;
    }//try / catch
  }//if( isotxt.find("(") != string::npos )
  
  bool isBackground = UtilityFunctions::icontains( isotxt, "background" );
  
  show = (show && (nuc || (el && m_showXrays->isChecked()) || isBackground
                   || (!rctnGammas.empty() && m_showGammas->isChecked())) );
  ...
  if( show )
  {
    ...
    m_currentlyShowingNuclide.showLines       = m_showLines->isChecked();
    ...
    if( isBackground )
    {
      ...
      {
        if( std::get<3>(bl)!=BackgroundXRay || m_showXrays->isChecked() )
...
//  double chartMaxSf = (islogy ? log(2.5) : 1.0/1.1);
  ...
  const bool showXrays = ((el && !nuc) && m_showXrays->isChecked());
...
//      throw runtime_error(msg);
  ...
  if( canvas )
  {
    ...
    m_currentlyShowingNuclide.toJson( json, m_persisted.size() );
    json += ");";
...
void PhotopeakLineDisplay::persistCurentLines()
{
...
void PhotopeakLineDisplay::serialize( std::string &xml_data  ) const
{
...
void PhotopeakLineDisplay::serialize(
                                  rapidxml::xml_node<char> *parent_node ) const
{
  ...
  if( m_currentlyShowingNuclide.empty() )
  {
    ...
    name = "ShowGammas";
    value = (m_showGammas->isChecked() ? "1" : "0");
    element = doc->allocate_node( rapidxml::node_element, name, value );
    node->append_node( element );

    name = "ShowXrays";
    value = (m_showXrays->isChecked() ? "1" : "0");
    element = doc->allocate_node( rapidxml::node_element, name, value );
    node->append_node( element );
...
void PhotopeakLineDisplay::deSerialize( std::string &xml_data  )
{
  clearAllLines();
  ...
  try
  {
    ...
    if( !base_node )
      throw runtime_error( "Couldnt get base node, PhotopeakLineDisplay" );
    ...
    if( !attr || !attr->value()
      ...
      throw runtime_error( "Mising or invalid PhotopeakLineDisplay version" );
...
//    updateDisplayChange();
  ...
  {
    cerr << "PhotopeakLineDisplay::deSerialize() caught: " << e.what() << endl;
    stringstream msg;
...
void PhotopeakLineDisplay::refreshLinesDisplayedToGui( int millisecdelay )
{
...
void PhotopeakLineDisplay::setIsotope( const SandiaDecay::Nuclide *nuc,
                                       double age )
{
  if( nuc )
  {
...
void PhotopeakLineDisplay::setNuclideAndAge( const string &name,
                                             const string &age )
{
...
void PhotopeakLineDisplay::setShieldingMaterialAndThickness( const string &name,
...
void PhotopeakLineDisplay::setElement( const SandiaDecay::Element *el )
{
  if( el )
  {
...
void PhotopeakLineDisplay::setReaction( const ReactionGamma::Reaction *rctn )
{
  if( rctn )
  {
...
void PhotopeakLineDisplay::fitPeaks()
{
  passMessage( "PhotopeakLineDisplay::fitPeaks() not implemented yet,"
...
void PhotopeakLineDisplay::clearAllLines()
{
  //m_fitPeaks->disable();
  m_persisted.clear();
  m_currentlyShowingNuclide.reset();
