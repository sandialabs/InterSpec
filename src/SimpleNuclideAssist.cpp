...
const std::string SimpleNuclideAssist::sm_dataFileName = "data/OUO_gamma_rays_of_interest.xml";
...
SimpleNuclideAssistPopup::SimpleNuclideAssistPopup( const float energy,
  ...
  : PopupDivMenu( 0, PopupDivMenu::TransientMenu ),
    ...
    m_assist( 0 )
{
  wApp->useStyleSheet( "InterSpec_resources/SimpleNuclideAssist.css" );
