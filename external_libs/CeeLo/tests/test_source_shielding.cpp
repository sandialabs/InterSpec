...
BOOST_AUTO_TEST_CASE(point_source_pb_spherical_shell) {
    ...
    calc_pb.set_detector(&nai, CylinderDims{3.81, 7.62});
...
BOOST_AUTO_TEST_CASE(source_material_reduces_efficiency) {
    ...
    calc_water.set_detector(&nai, CylinderDims{3.81, 7.62});
...
BOOST_AUTO_TEST_CASE(multi_shield_layers) {
    ...
    calc_1.set_detector(&nai, CylinderDims{3.81, 7.62});
    ...
    calc_2.set_detector(&nai, CylinderDims{3.81, 7.62});
