...
```
xcrun actool InterSpec.icon --compile ./tmp --platform macosx --target-device mac --minimum-deployment-target 12.3 --app-icon InterSpec --include-all-app-icons --output-partial-info-plist /dev/null
```
