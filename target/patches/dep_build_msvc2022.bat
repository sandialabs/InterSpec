...
if not exist %EIGEN_BUILT_FILE% (
    ...
    cmake -DCMAKE_INSTALL_PREFIX=%MY_PREFIX% -DCMAKE_CXX_STANDARD=20 -DCMAKE_BUILD_TYPE=Release -DEIGEN_MPL2_ONLY=1 -DEIGEN_BUILD_SHARED_LIBS=OFF -DEIGEN_BUILD_DOC=OFF -DEIGEN_BUILD_TESTING=OFF .. && (
