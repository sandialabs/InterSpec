...
Chi2Graphic.prototype.setYAxisTitle = function( title, dontCallResize ){
  if( !title || (title.length === 0) )
  {
    this.options.yAxisTitle = null;
    if( this.yaxistitle ){
  ...
  if( !dontCallResize )
    this.handleResize();
}//Chi2Graphic.prototype.setYAxisTitle
  ...
  /*
   
   {
     ...
     "Points" : [
       {
         "color" : "rgb(224,63,13)",
         "energy" : 143.759994506835938,
         "nuclide" : "U235",
         "numSigmaOff" : 323.65835665114929,
         "observedOverExpected" : 3.792745360236433e21,
         "observedOverExpectedUncert" : 1.171836067969779e19
       },
       {
         "color" : "rgb(224,63,13)",
         "energy" : 163.3800048828125,
         "nuclide" : "U235",
         "numSigmaOff" : 243.060712914508372,
         "observedOverExpected" : 4.281436266644729e15,
         "observedOverExpectedUncert" : 17614678305295
       },
       ...
     ]
   });
